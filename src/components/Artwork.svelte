...
<img src={`${cdnurl}/${thumb}`} on:click={() => (open=true)} class="rounded-xl aspect-square object-cover object-center cursor-pointer dark:brightness-[.8] dark:contrast-[1.2]" loading="lazy"/>
